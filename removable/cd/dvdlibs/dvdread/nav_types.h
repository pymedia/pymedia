...
#else
  unsigned short x_end            : 10;
  unsigned short zero1            : 2;
  unsigned short x_start          : 10;
  unsigned short btn_coln         : 2;

  unsigned char up               : 6;
  unsigned char zero3            : 2;

  unsigned short y_end            : 10;
  unsigned char zero2            : 2;
  unsigned short y_start          : 10;
  unsigned char auto_action_mode : 2;

  unsigned char down             : 6;
