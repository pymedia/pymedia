...
static int rd8x8_c(/*MpegEncContext*/ void *c, uint8_t *src1, uint8_t *src2, int stride, int h){
    ...
    DECLARE_ALIGNED_8 (uint64_t, aligned_temp[sizeof(DCTELEM)*64/8]);
    DECLARE_ALIGNED_8 (uint64_t, aligned_bak[600]);
    // VC does not allow for dynamic stack arrays
...
#if ENABLE_VP3_DECODER== 1 || ENABLE_VP5_DECODER== 1 || ENABLE_VP6_DECODER== 1 || ENABLE_THEORA_DECODER== 1
